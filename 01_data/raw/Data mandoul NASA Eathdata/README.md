...
## 1. Request Parameters  
    ...
    Name: ndvi-mandoul-2019-2023  

    Date Completed:** 2026-03-22T04:03:24.677937  

    ID: d45a7b7d-6687-4918-8207-4f68e83dc7d0  
...
- Comma-separated values file with data extracted for a specific product
  - ndvi-mandoul-2019-2023-MOD13Q1-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - ndvi-mandoul-2019-2023-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - ndvi-mandoul-2019-2023-request.json
- xml file
  - ndvi-mandoul-2019-2023-MOD13Q1-061-metadata.xml  
